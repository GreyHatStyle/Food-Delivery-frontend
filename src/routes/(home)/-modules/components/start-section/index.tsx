  ...
  return (
    ...
    className="relative rounded-2xl bg-[#E7E8DE] flex justify-around xl:w-[75rem]">
        ...
        <div className="absolute h-full w-[45%] lg:w-[50%] top-[4rem] left-[5rem]">
          ...
          <InputGroupInput className="text-[0.8rem] sm:text-sm" placeholder="Search Your City.."/>
          <InputGroupAddon>
            <Search />
          </InputGroupAddon>
          <InputGroupAddon className="hidden text-sm sm:block" align="inline-end">0 results</InputGroupAddon>
          </InputGroup>
